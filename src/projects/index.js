import Persons from './01_persons/Persons'
import Login from './02_login/Login'
import JsonPlaceHolder from './03_jsonplaceholder/UserList'
...
AllProjectsArray.push(Login)
AllProjectsArray.push(JsonPlaceHolder)
